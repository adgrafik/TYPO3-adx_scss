...
formatter | Set the formatter: Options: `NULL` is normal formatting, `compact`, `compressed`, `crunched`, `debug`, `expanded`, `output_block` | `string` | `NULL`
...
### Configuration
	...
	plugin.tx_adxscss {
		...
		# Set the formatter: Options: 0 (default) is normal formatting, nested, compressed
		formatter = 
