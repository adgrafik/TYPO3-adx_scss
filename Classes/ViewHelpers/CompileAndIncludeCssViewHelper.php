...
class CompileAndIncludeCssViewHelper extends AbstractViewHelper {
	 ...
	 * @api
	 */
	public function render($data = NULL, $variables = NULL, $importPaths = NULL, $targetFilename = NULL, $returnUri = TRUE, $formatter = NULL, $numberPrecision = NULL, $lineNumberStyle = NULL, array $includeCssSettings = array()) {
		...
		ScssUtility::addCssFile($content, $includeCssSettings);
